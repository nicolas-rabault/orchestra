...
export const DEFAULTS = {
  ...
  // so a roadmap is this checkout's working state rather than something the repository carries. A
  // project that wants its roadmaps shared points this at `docs/roadmaps` and commits them like
