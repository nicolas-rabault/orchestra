...
export const DEFAULTS = {
  ...
  // something the repository carries. It is also what `destination: local`
  // (lib/roadmap/parse.mjs) reaches for in an ONLINE project, where the shared channel is the
  // issue tracker and a sweep roadmap must publish to neither.
  //
