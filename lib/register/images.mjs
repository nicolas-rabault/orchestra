...
//
// Pure: no filesystem here. Resolving a path against a root is `archiveImages.mjs`'s job — this
// module only says which strings in a block of text look like a path to an image.
