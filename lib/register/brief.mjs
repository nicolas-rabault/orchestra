...
whole repository, dispatch an Explore subagent and keep its conclusion, not its output. Read a
...
export function renderBrief(cfg, row, { git, base = null, note = null, relaunch = false, handover = null, repo = null, model: forced = null } = {}) {
