...
// conductor at every tick, so a half-written row is a real transient state — and `row.id.includes`
// on one of them threw out of the request handler and killed the whole server, answer channel
// included.
