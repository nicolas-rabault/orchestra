...
//   - P4's monitoring page (`monitor/progress.mjs`) tallies `landed` into the progress bar.
//   - P4's monitoring page (`monitor/model.mjs`) joins register rows to roadmap rows using
//     `branch`, `lane`, `session`.
//
