...
// in planetCraft, 2026-08-13: one second from the file changing to the event arriving.
//
...
// half an hour on 2026-08-13. The standing belief that made it look harmless is in planetCraft's
...
import { inboxPath, readJsonl, unconsumed, oneLine } from './inbox.mjs';
...
const lineFor = (e) => `ANSWER ${e.task ?? 'no task'} · ${e.pending ?? 'a free remark'} · ${e.ts} — "${oneLine(e.answer, ANSWER_CAP)}"`;
...
function newAnnouncements(entries, state, announced, now = Date.now()) {
