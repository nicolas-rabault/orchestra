...
//
// Armed by the conductor itself as a persistent Monitor at the top of its first tick. Every line it
// emits is delivered to that session as an event, whatever the session is doing — including sitting
// idle waiting for the user. Measured in this harness 2026-08-13: one second from the file changing
// to the event arriving.
//
