...
// nothing.
//
// Measured on this machine: four consecutive heartbeat slots (2026-08-17T18:23Z, 22:23Z,
// 2026-08-18T03:23Z, 08:23Z) stood down for `e3a9fcc5, pid 8237` while `journal.jsonl` took not one
// line between 08-17 22:01Z and 08-18 11:41Z. Four workers finished and sat uncollected about
// thirteen hours, until a human typed /orchestra.
...
// ran a full suite at ~4.5 minutes (see lock.mjs MAX_AGE_MS).
...
// question and the lock already answers it, above this line: `cron-tick.sh` takes `tick.lock` before
// it reaches the gate, so a conductor mid-tick refuses it the lock and the tick exits without ever
// consulting this file. Asking here as well would mean importing lock.mjs, which imports this one.
