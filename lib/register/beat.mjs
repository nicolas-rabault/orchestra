...
// question and the lock already answers it, above this line: the heartbeat (P5) takes `tick.lock`
// before it reaches the gate, so a conductor mid-tick refuses it the lock and the tick exits without
// ever consulting this file. Asking here as well would mean importing lock.mjs, which imports this one.
