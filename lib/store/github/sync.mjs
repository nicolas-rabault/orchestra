...
// explain it (board.mjs: 22 of 41 landed rows in planetCraft carried `subjects: []`, so this is the
// common case, not an edge one). Leaving the label on an unverified row is a shared channel that is
