...
// programme, by the `Programme: #N` line publish.mjs already writes, so opening a roadmap is ONE
...
// back quietly. It is the same match publish.mjs uses to decide whether to create a programme or
// update one, kept here so both read the channel the same way.
