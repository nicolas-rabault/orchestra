...
Run \`orchestra init --mode online\` or \`orchestra init --mode offline\`:
  ...
  offline   roadmaps are markdown under .orchestra/roadmaps — gitignored, never committed by
            orchestra itself — and "is somebody already working on this" is answered for this
            machine only
