...
// the browser (served at /answers.mjs) and imported by the tests, the same way inbox.mjs is shared
// by the server and the hook: the rule that decides what the page remembers is written once.
//
