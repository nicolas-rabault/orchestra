...
//
// - every field required        a task missing Touches cannot be collision-checked, so it silently
//                              serialises the whole fleet or, worse, collides.
