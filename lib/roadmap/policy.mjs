...
// pure and here rather than inside `hooks/guard-claim.mjs` (spec §10, a later phase), because a
// hook reads stdin and spawns a child process at import: nothing can unit-test it, and in the
// project this comes from its three refusals were exercised by nothing. It is roadmap policy, not
// hook plumbing. The hook owns the wording.
//
