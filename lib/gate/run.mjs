...
import { BIN, gatePaths, gitOk, precheck, withMutex, writeAtomic } from './land.mjs';
...
export function queueList(cfg) {
  ...
  //
  // And the write itself only happens when reaping actually changed something: the common call is
